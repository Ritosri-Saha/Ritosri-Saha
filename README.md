...
🎓 I'm an **Electronics and Communication Engineering** undergraduate with a strong passion for  
🌐 **frontend development and modern web technologies**.

I love turning ideas into **clean, responsive, and visually pleasing interfaces**.  
Alongside frontend, I’m exploring **AI/ML fundamentals** to build intelligent, future-ready web applications.

My interests lie at the intersection of  
**design × development × emerging technology** 🚀
...
- ⚛ Building accessible and scalable React applications  
- 🤖 AI/ML basics for intelligent web integration  
- 🎨 UI/UX improvement through real-world designs  
- 🧩 Creative + functional project development
...
- 🌙 Love minimalist & dreamy UI themes  
- 🎧 Code better with music on  
- 🧠 Enjoy both logic and visual creativity  
- 🚀 Obsessed with futuristic technology
